...
public class ItemFar extends Item {

	@Override
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		ItemStack itemstack = playerIn.getHeldItem(handIn);
		worldIn.createExplosion(playerIn, playerIn.posX, playerIn.posY, playerIn.posZ, 3.0F, true);
	...
	public void addInformation(ItemStack stack, World clientWorld, List<String> tooltips, ITooltipFlag flag) {
		tooltips.add(I18n.format("ItemMusicFAR"));
	}
