...
public class EntityMusic extends EntityArrow{
	
	
	public boolean impacted = false;

    public EntityMusic(World world, double x, double y, double z) {
        super(world, x, y, z);
    }

    public EntityMusic(World world, EntityLivingBase entity) {
        super(world, entity);

    }

    public EntityMusic(World world) {
        super(world);
    }
    ...
    public void barrage() {//TODO, this logic may be borked.
        ...
        for (int i = 0; i < 10; i++) {
            ...
            EntityArrow arrow = new EntityMusic(world, x, y, z);
