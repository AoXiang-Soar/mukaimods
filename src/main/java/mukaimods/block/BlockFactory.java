...
public class BlockFactory {
	/**
	 * 调用此函数可以返回一个简单的方块，不可用于没有无参构造方法的类
	 * 
	 * @param cls 该方块的类，如果你的方块是没有任何额外功能的普通方块（如钻石块），可以填null
	 * @param unlocalizedName 该方块的注册名
	 ...
	 * @return 一个方块对象
	 */
	public static Block create(@Nullable Class<? extends Block> cls, String unlocalizedName, @Nullable Float resistance,
		...
		try {
			...
			b.setUnlocalizedName(unlocalizedName);
			if (hardness != null)
